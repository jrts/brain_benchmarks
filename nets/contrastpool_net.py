...
from layers.graphsage_diff_layer import GraphSageLayer, DenseGraphSage
from layers.contrastpool_layer import DiffCSLayer, DenseDiffPool
...
class ContrastPoolNet(nn.Module):
    ...
    def __init__(self, net_params, pool_ratio=0.5):
        ...
        net_params['max_num_node'] = input_dim
        ...
        self.first_diffpool_layer = DiffCSLayer(pool_embedding_dim, self.assign_dim, self.hidden_dim, activation,
